...
namespace FoxtaurServer.Migrations.MainDb
{
    ...
    [Migration("20230312101820_AddedDistances")]
    partial class AddedDistances
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DistanceLocation1", b =>
                {
                    b.Property<Guid>("AsExpectedFoxOrderLocationInDistancesId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("ExpectedFoxesOrderLocationsId")
                        .HasColumnType("uuid");

                    b.HasKey("AsExpectedFoxOrderLocationInDistancesId", "ExpectedFoxesOrderLocationsId");

                    b.HasIndex("ExpectedFoxesOrderLocationsId");

                    b.ToTable("DistancesToExpectedFoxesOrderLocations", (string)null);
                });
            ...
            modelBuilder.Entity("DistanceLocation1", b =>
                {
                    b.HasOne("FoxtaurServer.Dao.Models.Distance", null)
                        .WithMany()
                        .HasForeignKey("AsExpectedFoxOrderLocationInDistancesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FoxtaurServer.Dao.Models.Location", null)
                        .WithMany()
                        .HasForeignKey("ExpectedFoxesOrderLocationsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
